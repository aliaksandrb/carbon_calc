...
class FieldsControllerTest < ActionController::TestCase
  ...
  test "should create field" do
    assert_difference('Field.count') do
      post :create, field: { default_value: @field.default_value, field_type: @field.field_type, name: @field.name }
    end
  ...
  test "should update field" do
    patch :update, id: @field, field: { default_value: @field.default_value, field_type: @field.field_type, name: @field.name }
    assert_redirected_to field_path(assigns(:field))
  end
